...
const DirectorMessage = () => {
  ...
  return (
    <section className="py-8 bg-gradient-to-b from-slate-50 to-white font-poppins dark:from-gray-800 dark:to-gray-900">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6">
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 font-semibold text-sm">Director, TG ANB</p>
                  </div>
                </div>
                
                <blockquote className="text-sm text-gray-700 dark:text-gray-300 italic leading-relaxed border-l-4 border-slate-600 pl-4 mb-4">
                ...
                <Button 
                  className="bg-gradient-to-r from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 rounded-full px-6 text-sm"
